...
ActiveRecord::Schema.define(version: 2021_03_12_012539) do
  ...
  create_table "subscribers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_purchase_id"], name: "index_subscribers_on_item_purchase_id"
  end
  ...
  add_foreign_key "subscribers", "item_purchases"
end
